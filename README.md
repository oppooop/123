...
TP=function(p)
    task.spawn(function()
        pcall(function()
            ...
            local B=TweenInfo.new((p.Position-game.Players.LocalPlayer.Character.Root.Position).Magnitude/230,Enum.EasingStyle.Linear)
...
if S and game.Players.LocalPlayer.Character:FindFirstChild("Root")then 
    pcall(function()
        if(game.Players.LocalPlayer.Character.HumanoidRootPart.Position-p.Position).Magnitude>=79 then 
            spawn(function()
                pcall(function()if(game.Players.LocalPlayer.Character.Root.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude>230 then game.Players.LocalPlayer.Character.Root.CFrame=game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
else game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame=game.Players.LocalPlayer.Character.Root.CFrame
end
end)
end)
elseif(game.Players.LocalPlayer.Character.HumanoidRootPart.Position-p.Position).Magnitude>=55 and(game.Players.LocalPlayer.Character.HumanoidRootPart.Position-p.Position).Magnitude<79 then 
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame=p
elseif(game.Players.LocalPlayer.Character.HumanoidRootPart.Position-p.Position).Magnitude<55 then 
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame=p
end
end)
end
...
local serv = win:Server("Monster x","")
...
AutoFarm:Toggle("Fast Attack Pc", false, function(bool)
 _G.FastAttackD = bool
end)
AutoFarm:Toggle("Fast Attack Android", false, function(vu)
 _G.FastAttack = vu
end)
...
AutoFarm:Toggle("AutoFarm Level",_G.Auto_Farm, function(value)
_G.AutoFarm = value
StopTween(_G.AutoFarm)
    ...
    AutoFarm:Toggle("Auto Farm Bone", _G.Auto_Bone, function(vu)
		_G.Auto_Bone = vu
...
function topos(P1)
    ...
    local MobKilled = AutoFarm:Label("Killed")
    ...
    AutoFarm:Toggle("Auto Dought Boss",_G.AutoDoughtBoss,function(value)
                            ...
                            if game:GetService("Workspace").Map.CakeLoaf.BigMirror.Other.Transparency == 1 then
                                if game:GetService("Workspace").Enemies:FindFirstChild("Cookie Crafter [Lv. 2200]") or game:GetService("Workspace").Enemies:FindFirstChild("Cake Guard [Lv. 2225]") or game:GetService("Workspace").Enemies:FindFirstChild("Baking Staff [Lv. 2250]") or game:GetService("Workspace").Enemies:FindFirstChild("Head Baker [Lv. 2275]") then
                                    ...
                                    if game:GetService("ReplicatedStorage"):FindFirstChild("Cookie Crafter [Lv. 2200]") then
                                        topos(game:GetService("ReplicatedStorage"):FindFirstChild("Cookie Crafter [Lv. 2200]").HumanoidRootPart.CFrame * Farm_Mode)
                                    else
                                        if game:GetService("ReplicatedStorage"):FindFirstChild("Cake Guard [Lv. 2225]") then
                                            topos(game:GetService("ReplicatedStorage"):FindFirstChild("Cake Guard [Lv. 2225]").HumanoidRootPart.CFrame * Farm_Mode) 
                                        else
                                            if game:GetService("ReplicatedStorage"):FindFirstChild("Baking Staff [Lv. 2250]") then
                                                topos(game:GetService("ReplicatedStorage"):FindFirstChild("Baking Staff [Lv. 2250]").HumanoidRootPart.CFrame * Farm_Mode)
                                            else
                                                if game:GetService("ReplicatedStorage"):FindFirstChild("Head Baker [Lv. 2275]") then
                                                    topos(game:GetService("ReplicatedStorage"):FindFirstChild("Head Baker [Lv. 2275]").HumanoidRootPart.CFrame * Farm_Mode)
                                                end
                                            end
                                        end
                                    end                       
                                ...
                                if game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") then
                                    topos(game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]").HumanoidRootPart.CFrame * Farm_Mode)
                                else
                                    if game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") then
                                        topos(game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]").HumanoidRootPart.CFrame * Farm_Mode)
                                    end
                                end
                            end
                        end
...
AutoFarm:Toggle("Auto Elite Hunter",_G.AutoElitehunter,function(value)
				...
				while wait() do
					if AutoBartilo then
						...
						elseif game.Players.LocalPlayer.Data.Level.Value >= 800 and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 2 then
							...
							wait(1)
                            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-1804.36962890625, 16.747333526611328, 1750.288818359375)
							wait(1)
...
AutoFarm:Toggle("Auto Evo Race",_G.Auto_EvoRace, function(value)
...
StopTween(_G.Auto_EvoRace)
 ...
 spawn(function()
    ...
    AutoFarm:Toggle("Auto Swan Glasses",_G.AutoFarmSwanGlasses,function(value)
    ...
    AutoFarm:Toggle("Auto Swan Glasses Hop",_G.AutoFarmSwanGlasses_Hop,function(value)
...
_G.SelectPoint1 = 1
Stats:Slider("PointMelee", 1,500,_G.SelectPoint1, function(Point)
    SelectPoint1 = Point
end)
Stats:Line()
...
SelectPoint2 = 1
Stats:Slider("PointDefense", 1,500,_G.SelectPoint2, function(Point)
    SelectPoint2 = Point
end)
Stats:Line()
...
_G.SelectPoint3 = 1
Stats:Slider("PointSword", 1,500,_G.SelectPoint3, function(Point)
    SelectPoint3 = Point
end)
Stats:Line()
...
_G.SelectPoint4 = 1
Stats:Slider("PointGun", 1,500,_G.SelectPoint4, function(Point)
    SelectPoint4 = Point
end)
Stats:Line()
...
_G.SelectPoint5 = 1
Stats:Slider("PointDevil Fruit", 1,500,_G.SelectPoint5, function(Point)
    SelectPoint5 = Point
end)
Stats:Line()
...
_G.SelectPoint = 1
Stats:Slider("Point+Devil Fruit+Gun+Sword+Defense+Melee", 1,500,_G.SelectPoint, function(Point)
    SelectPoint = Point
end)
...
spawn(function()
	while wait(.1) do
		if Mad then
			game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AddPoint", "Melee", SelectPoint or SelectPoint1)
		end
	end
end)
...
spawn(function()
	while wait(.1) do
		if Gan then
			game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AddPoint", "Defense", SelectPoint or SelectPoint2)
		end
	end
end)
...
spawn(function()
	while wait(.1) do
		if Dap then
			game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AddPoint", "Sword", SelectPoint or SelectPoint3 )
		end
	end
end)
...
spawn(function()
	while wait(.1) do
		if Pun then
			game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AddPoint", "Gun", SelectPoint or SelectPoint4)
		end
	end
end)
...
spawn(function()
	while wait(.1) do
		if DevilFruit then
			game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AddPoint", "Demon Fruit", SelectPoint or SelectPoint5 )
		end
	end
end)
...
spawn(function()
	while wait(.1) do
        if Type == 1 then
		    Farm_Mode = CFrame.new(0,  _G.Heightdistance, -30)
        elseif  Type == 1 then
		    Farm_Mode = CFrame.new(30,  _G.Heightdistance, 0)
        elseif  Type == 2 then
		    Farm_Mode = CFrame.new(0,  _G.Heightdistance, 30)
        elseif  Type == 3 then
		    Farm_Mode = CFrame.new(-30,  _G.Heightdistance, 0)
...
spawn(function()
        pcall(function()
            while wait() do
       if _G.AutoDoughtBoss or _G.AutoElitehunter or _G.AutoRaid or _G.AutoRaid or _G.Auto_EvoRace or _G.AutoElitehunter or _G.Clip or _G.AutoRaid or RaidSuperhuman or _G.Auto_Bone or _G.AutoFarm or Auto_Farm or AutoBartilo or AutoRengoku or AutoBuychip or _G.AutoRaid or NextIsland or AutoRengoku then                   
				...
				if Magnet then
					...
					for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
						if _G.AutoFarm and MagnetActive and v.Name == Mon and (Mon == "Factory Staff [Lv. 800]" or Mon == "Monkey [Lv. 14]" or Mon == "Dragon Crew Warrior [Lv. 1575]" or Mon == "Dragon Crew Archer [Lv. 1600]") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 375 then
							...
							sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
						elseif _G.AutoFarm and MagnetActive and v.Name == Mon and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 375 then
							v.HumanoidRootPart.Size = Vector3.new(80,80,80)
							v.HumanoidRootPart.CFrame = PosMon
							v.Humanoid:ChangeState(14)
							v.HumanoidRootPart.CanCollide = false
						...
						elseif Auto_Bone and BoneMagnet then
							if (v.Name == "Reborn Skeleton [Lv. 1975]" or v.Name == "Living Zombie [Lv. 2000]" or v.Name == "Demonic Soul [Lv. 2025]" or v.Name == "Posessed Mummy [Lv. 2050]") and (v.HumanoidRootPart.Position - MainMonBone.Position).Magnitude <= 375 then
								v.Head.CanCollide = false
								v.HumanoidRootPart.CanCollide = false
								v.Humanoid:ChangeState(14)
								v.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
				...
				if _G.BringMonster then
					...
					for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
						...
						if _G.AutoEctoplasm and StartEctoplasmMagnet then
							if string.find(v.Name, "Ship") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - EctoplasmMon.Position).Magnitude <= 375 then
								v.HumanoidRootPart.Size = Vector3.new(50,50,50)
						...
						if _G.AutoRengoku and StartRengokuMagnet then
							if (v.Name == "Snow Lurker [Lv. 1375]" or v.Name == "Arctic Warrior [Lv. 1350]") and (v.HumanoidRootPart.Position - RengokuMon.Position).Magnitude <= 375 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
								v.HumanoidRootPart.Size = Vector3.new(50,50,50)
								v.Humanoid:ChangeState(14)
								v.HumanoidRootPart.CanCollide = false
								v.Head.CanCollide = false
						...
						if _G.AutoBartilo and AutoBartiloBring then
							if v.Name == "Swan Pirate [Lv. 775]" and (v.HumanoidRootPart.Position - PosMonBarto.Position).Magnitude <= 375 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
								v.HumanoidRootPart.Size = Vector3.new(50,50,50)
								v.Humanoid:ChangeState(14)
								v.HumanoidRootPart.CanCollide = false
								v.Head.CanCollide = false
						...
						if _G.AutoDoughtBoss and MagnetDought then
							if (v.Name == "Cookie Crafter [Lv. 2200]" or v.Name == "Cake Guard [Lv. 2225]" or v.Name == "Baking Staff [Lv. 2250]" or v.Name == "Head Baker [Lv. 2275]") and (v.HumanoidRootPart.Position - PosMonDoughtOpenDoor.Position).Magnitude <= 375 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
								v.HumanoidRootPart.Size = Vector3.new(50,50,50)
								v.Humanoid:ChangeState(14)
								v.HumanoidRootPart.CanCollide = false
								v.Head.CanCollide = false
			...
			if AutoRengoku then
               game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetSpawnPoint")
				if game:GetService("Workspace").Enemies:FindFirstChild("Snow Lurker [Lv. 1375]") then
					...
					topos(CFrame.new(5587.58203, 261.724365, -6802.58447, -0.997992337, -9.04556874e-09, 0.0633349568, -7.14217352e-09, 1, 3.02792422e-08, -0.0633349568, 2.97661007e-08, -0.997992337))
				end
			end
		end)
	end
